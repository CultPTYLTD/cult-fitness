        ...
        <div className="p-6 bg-background">
          ...
          <div className="text-center mb-8">
            <div className="bg-secondary/50 rounded-2xl py-6 px-8 inline-block mb-2">
              <span className="text-4xl font-serif font-light text-foreground">0 ml</span>
            </div>
            <p className="text-muted-foreground">of 2,500 ml</p>
          </div>
          ...
          <div className="text-center mb-8">
            ...
            <div className="text-4xl font-serif font-light text-foreground">
              0 <span className="text-lg">ml</span>
            </div>
          </div>
